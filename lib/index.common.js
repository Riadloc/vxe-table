    ...
    return this.$nextTick().then(function () {
      ...
      if (scope && $refs.tableBody && editRules) {
        ...
        if (_this26.hasCellRules(type, row, column)) {
          ...
          if (cell) {
            var key = "".concat(column.property, "_").concat(row._XID);
...
function renderColumn(h, _vm, $table, $seq, seq, fixedType, rowLevel, row, rowIndex, $rowIndex, column, columnIndex, $columnIndex) {
  ...
  validStore = Object.assign({
    ...
    content: '',
    rule: null
  }, validStore["".concat(column.property, "_").concat(row._XID)]);
  var validError = validStore.visible;
  ...
  var isLastRow = rowIndex === tableData.length - 1; // 在 v3.0 中废弃 selectConfig
    ...
    tdOns.click = function (evnt) {
      ...
      if (mouseConfig.selected) {
        ...
        if (target.classList.contains('col--selected')) {
          var layerY = evnt.layerY;

          var _target$getBoundingCl = target.getBoundingClientRect(),
              _height = _target$getBoundingCl.height;

          if (layerY > _height || layerY < 0) {
            var selected = editStore.selected;
            var _column = selected.column,
                _row = selected.row;
            var value = _row[_column.property];
            tableData.forEach(function (row) {
              UtilTools.setCellValue(row, _column, value);
            });
          }
        }
      }
  ...
  var isActived = editConfig && editRender && actived.row === row && (actived.column === column || editConfig.mode === 'row');
  return h('td', {
    class: ['vxe-body--column', column.id, (_ref2 = {}, _defineProperty(_ref2, "col--".concat(cellAlign), cellAlign), _defineProperty(_ref2, 'col--edit', editRender), _defineProperty(_ref2, 'col--index', column.type === 'index'), _defineProperty(_ref2, 'col--ellipsis', hasEllipsis), _defineProperty(_ref2, 'row--last', isLastRow), _defineProperty(_ref2, 'edit--visible', editRender && editRender.type === 'visible'), _defineProperty(_ref2, 'fixed--hidden', fixedHiddenColumn), _defineProperty(_ref2, 'col--dirty', isDirty), _defineProperty(_ref2, 'col--actived', isActived), _defineProperty(_ref2, 'col--valid-error', validError), _ref2), UtilTools.getClass(className, params), UtilTools.getClass(cellClassName, params)],
  ...
  }, column.renderCell(h, params)), hasDefaultTip ? validError && isActived ? h('div', {
...
/* harmony default export */ var validator_src_methods = ({
  ...
  _clearValidate: function _clearValidate(key) {
  ...
  showValidTooltip: function showValidTooltip(params) {
    ...
    this.$nextTick(function () {
      ...
      _this5.$set(_this5.validStore, key, {
        row: row,
        column: column,
        rule: rule,
        content: content,
